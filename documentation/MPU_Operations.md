...
| :--- | :--- | :--- | :--- |
| `000` | **`MEQ`** | **`R3`** == `0` | Branch if zero (Equal). |
| `001` | **`MNQ`** | **`R3`** != `0` | Branch if not zero (Not Equal). |
| `010` | **`MSL`** | **`R3`** < `0` | Branch if negative (Less Than). |
| `011` | **`MLQ`** | **`R3`** <= `0` | Branch if negative or zero (Less or Equal). |
| `100` | **`MSG`** | **`R3`** > `0` | Branch if positive (Greater Than). |
| `101` | **`MGQ`** | **`R3`** >= `0` | Branch if positive or zero (Greater or Equal). |
...
| Opcode | Mnemonic | Condition | Hardware Description |
| :--- | :--- | :--- | :--- |
| `000` | **`DEQ`** | **`R1`** == **`R2`** | Branch if Equal. |
| `001` | **`DNQ`** | **`R1`** != **`R2`** | Branch if Not Equal. |
| `010` | **`DSL`** | **`R1`** < **`R2`** | Branch if Less Than (Signed). |
| `011` | **`DLQ`** | **`R1`** <= **`R2`** | Branch if Less or Equal (Signed). |
| `100` | **`DSG`** | **`R1`** > **`R2`** | Branch if Greater Than (Signed). |
| `101` | **`DGQ`** | **`R1`** >= **`R2`** | Branch if Greater or Equal (Signed). |
